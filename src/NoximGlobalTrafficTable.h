/*****************************************************************************
  ...
  NoximGlobalTrafficTable.h -- Global Traffic Table definition

*****************************************************************************/

#ifndef __NoximGlobalTrafficTable_H__
#define __NoximGlobalTrafficTable_H__
...
public:
  ...
  double getCumulativePirPor(const int src_id, const int ccycle, const bool pir_not_por,
